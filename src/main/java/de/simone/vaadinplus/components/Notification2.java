...
import de.simone.vaadinplus.utilities.BorderColor;
...
public class Notification2 extends Layout implements HasTheme {
    ...
    public Notification2(String title, String description) {
        this(title, new Text(description), Type.INFO);
    }

    public Notification2(String title, String description, Type type) {
        this(title, new Text(description), type);
    }

    public Notification2(String title, Component description) {
        this(title, description, Type.INFO);
    }

    public Notification2(String title, Component description, Type type) {
    ...
    private void themeButton(Button button) {
        if (this.type.equals(Notification2.Type.SUCCESS)) {
            button.addThemeVariants(ButtonVariant.LUMO_SUCCESS);
        } else if (this.type.equals(Notification2.Type.ERROR)) {
