...
import de.simone.ui.component.AvatarBorderColorIcon;
...
public class FormAvatarIcon extends Form {
    ...
    private void setAvatar() {
        ...
        AvatarIcon avatarIcon = new AvatarIcon(getClass().getResource("/ui/images/profile_6.jpg"), width, height, value);
