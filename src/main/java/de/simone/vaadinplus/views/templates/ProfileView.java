...
@SuppressWarnings({"rawtypes","unchecked", "java:S1192"})
public class ProfileView extends Main {
    ...
    public Component createNotifications() {
        ...
        emailNotifications.setItems("Newsletters", "Promotional offers", "Account updates",
                "New messages or activities", "Events or upcoming appointments");
        ...
        pushNotifications.setItems("New messages", "Friend requests", "Activity updates", "Order status updates",
                "Reminders or alerts");
