...
public class CustomersView extends Main {
    ...
    private static final Person PERSON_1 = new Person("Ava Smith", "ava.smith@company.com",
            "https://images.unsplash.com/photo-1530785602389-07594beb8b73?&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80");
    private static final Person PERSON_2 = new Person("Emma Johnson", "emma.johnson@company.com",
            "https://images.unsplash.com/photo-1553514029-1318c9127859?&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80");
    private static final Person PERSON_3 = new Person("Mia Williams", "mia.williams@company.com",
    ...
    private Component createHeader() {
        ...
        Paragraph description = new Paragraph(
                "View and manage customer information, including contact details and purchase history");
    ...
    private Component createContent() {
        ...
        grid.addComponentColumn(this::renderName)
                .setAutoWidth(true)
                .setHeader("Name");
        grid.addColumn(new LocalDateRenderer<>(DummyItem::getDate,
