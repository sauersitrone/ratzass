...
package de.simone.test.gdxai.btree;
...
public final class KryoUtils {
    ...
    static {
        ...
        kryo.register(ConstantDoubleDistribution.class, new DistributionSerializer<ConstantDoubleDistribution>() {
            ...
            @Override
            public ConstantDoubleDistribution read(Kryo kryo, Input input,
                    Class<? extends ConstantDoubleDistribution> type) {
        ...
        kryo.register(ConstantFloatDistribution.class, new DistributionSerializer<ConstantFloatDistribution>() {
            ...
            @Override
            public ConstantFloatDistribution read(Kryo kryo, Input input,
                    Class<? extends ConstantFloatDistribution> type) {
        ...
        kryo.register(ConstantIntegerDistribution.class, new DistributionSerializer<ConstantIntegerDistribution>() {
            ...
            @Override
            public ConstantIntegerDistribution read(Kryo kryo, Input input,
                    Class<? extends ConstantIntegerDistribution> type) {
        ...
        kryo.register(ConstantLongDistribution.class, new DistributionSerializer<ConstantLongDistribution>() {
            ...
            @Override
            public ConstantLongDistribution read(Kryo kryo, Input input,
                    Class<? extends ConstantLongDistribution> type) {
        ...
        kryo.register(GaussianDoubleDistribution.class, new DistributionSerializer<GaussianDoubleDistribution>() {
            ...
            @Override
            public GaussianDoubleDistribution read(Kryo kryo, Input input,
                    Class<? extends GaussianDoubleDistribution> type) {
        ...
        kryo.register(GaussianFloatDistribution.class, new DistributionSerializer<GaussianFloatDistribution>() {
            ...
            @Override
            public GaussianFloatDistribution read(Kryo kryo, Input input,
                    Class<? extends GaussianFloatDistribution> type) {
        ...
        kryo.register(TriangularDoubleDistribution.class, new DistributionSerializer<TriangularDoubleDistribution>() {
            ...
            @Override
            public TriangularDoubleDistribution read(Kryo kryo, Input input,
                    Class<? extends TriangularDoubleDistribution> type) {
        ...
        kryo.register(TriangularFloatDistribution.class, new DistributionSerializer<TriangularFloatDistribution>() {
            ...
            @Override
            public TriangularFloatDistribution read(Kryo kryo, Input input,
                    Class<? extends TriangularFloatDistribution> type) {
        ...
        kryo.register(TriangularIntegerDistribution.class, new DistributionSerializer<TriangularIntegerDistribution>() {
            ...
            @Override
            public TriangularIntegerDistribution read(Kryo kryo, Input input,
                    Class<? extends TriangularIntegerDistribution> type) {
        ...
        kryo.register(TriangularLongDistribution.class, new DistributionSerializer<TriangularLongDistribution>() {
            ...
            @Override
            public TriangularLongDistribution read(Kryo kryo, Input input,
                    Class<? extends TriangularLongDistribution> type) {
        ...
        kryo.register(UniformDoubleDistribution.class, new DistributionSerializer<UniformDoubleDistribution>() {
            ...
            @Override
            public UniformDoubleDistribution read(Kryo kryo, Input input,
                    Class<? extends UniformDoubleDistribution> type) {
        ...
        kryo.register(UniformFloatDistribution.class, new DistributionSerializer<UniformFloatDistribution>() {
            ...
            @Override
            public UniformFloatDistribution read(Kryo kryo, Input input,
                    Class<? extends UniformFloatDistribution> type) {
        ...
        kryo.register(UniformIntegerDistribution.class, new DistributionSerializer<UniformIntegerDistribution>() {
            ...
            @Override
            public UniformIntegerDistribution read(Kryo kryo, Input input,
                    Class<? extends UniformIntegerDistribution> type) {
        ...
        kryo.register(UniformLongDistribution.class, new DistributionSerializer<UniformLongDistribution>() {
            ...
            @Override
            public UniformLongDistribution read(Kryo kryo, Input input,
                    Class<? extends UniformLongDistribution> type) {
