...
public class Header extends Layout implements HasTheme {
    ...
    public Header(String title, HeadingLevel level) {
        ...
        // terry: corrected indentation
        heading.addClassNames(Margin.Bottom.MEDIUM);
    ...
    public void setHeading(String title, HeadingLevel level) {
        Component heading2 = level.getComponent(title);
        if (this.heading != null) {
            this.column.replace(this.heading, heading2);
        }
    ...
    // terry
    public Layout getActionsLayout() {
        return this.actions;
    }
