...
import de.simone.ui.menu.MyMenuValidation;
import de.simone.ui.system.Form;
import de.simone.ui.system.FormSearch;
...
public class FormSearchPanel extends JPanel {
    ...
    private void init() {
        ...
        textSearch.putClientProperty(FlatClientProperties.TEXT_FIELD_LEADING_ICON, new FlatSVGIcon("ui/icons/search.svg", 0.4f));
    ...
    private class Item extends JButton {
        ...
        protected Component createRecentOption() {
            ...
            if (!isFavorite) {
                ...
                JLabel label = new JLabel(new SVGIconUIColor("ui/icons/favorite_filled.svg", 0.4f, "Component.accentColor", 0.8f));
                label.putClientProperty(FlatClientProperties.STYLE, "" +
                        "border:3,3,3,3;");
                panel.add(label);
            }
        ...
        private JButton createButton(String name, String icon, float scale, String hoverKey, float alpha) {
            SVGIconUIColor svgIcon = new SVGIconUIColor("ui/icons/" + icon, scale, "Label.disabledForeground", alpha);
