package de.simone.frontend.components.cropper.settings;
...
import de.simone.frontend.components.cropper.events.CropperImageEncodeEvent.CropData;
import de.simone.frontend.components.cropper.settings.enums.DragMode;
import de.simone.frontend.components.cropper.settings.enums.ViewMode;
...
public class CropperSettings {
  ...
  public void setRoundCropBox(boolean roundCropBox) {
    ...
    public void rotate() {
    this.cropData.rotate -= 45;
  }

  public void reflectX() {
    this.cropData.scaleX = this.cropData.scaleX * -1;
  }

  public void reflectY() {
    this.cropData.scaleY = this.cropData.scaleY * -1;
  }

    public String getCropData() {
    try {
      this.cropData.roundBox = roundCropBox;
  ...
  public String toJSON() {
        String cropDataString = "";
    // crop data send if already has been initialized
    if (cropData.x != Integer.MAX_VALUE) {
      cropDataString = ", \"cropData\": " + getCropData();
    }
