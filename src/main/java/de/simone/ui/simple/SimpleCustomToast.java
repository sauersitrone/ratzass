...
public class SimpleCustomToast extends ToastCustomPanel {
    ...
    private void init() {
        ...
        JLabel labelProfile = new JLabel(new AvatarIcon(getClass().getResource("/ui/images/profile_2.jpg"), 50, 50, 999));
        ...
        JButton buttonClose = new JButton(new FlatSVGIcon("ui/icons/close.svg", 0.3f));
