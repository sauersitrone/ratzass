package de.simone.vaadinplus.views.templates;
...
import de.simone.vaadinplus.themes.UploadTheme;
...
public class FilesView extends Main {
    ...
    private static final Person PERSON_1 = new Person("Ava Smith", "ava.smith@company.com", "https://images.unsplash.com/photo-1530785602389-07594beb8b73?&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80");

    private static final Person PERSON_2 = new Person("Emma Johnson", "emma.johnson@company.com", "https://images.unsplash.com/photo-1553514029-1318c9127859?&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80");

    private static final Person PERSON_3 = new Person("Mia Williams", "mia.williams@company.com", "https://images.unsplash.com/photo-1580489944761-15a19d654956?&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80");
