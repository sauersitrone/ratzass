(define (domain starcraft)
    ...
    (:action build-terran-marine
        ...
        :precondition (and (>= (mineral-amount ?mineral) 50) (exists (?unit - Terran_Barracks) (has-unit ?unit)))
        :effect (and (increase (Terran_Marine-amount) 1))
    )
    ...
    (:action build-terran-siege-tank-tank-mode
        ...
        :effect (and (decrease (mineral-amount) 150) (decrease (gas-amount)  100) (increase (Terran_Siege_Tank_Tank_Mode-amount ?unit) 1) (has-unit ?unit))
    )
    ...
    (:action build-terran-siege-tank-tank-mode-turret
        ...
        :precondition (and (>= (mineral-amount ?mineral) 1) (>= (gas-amount ?gas) 1))
        :effect (and (decrease (mineral-amount) 1) (decrease (gas-amount)  1) (increase (Terran_Siege_Tank_Tank_Mode_Turret-amount ?unit) 1) (has-unit ?unit))
    )
    ...
    (:action build-terran-vulture-spider-mine
        ...
        :effect (and (decrease (mineral-amount)   1) (increase (Terran_Vulture_Spider_Mine-amount ?unit) 1) (has-unit ?unit))
    )
    ...
    (:action build-hero-alan-schezar-turret
        ...
        :precondition (and (>= (mineral-amount ?mineral) 1) (>= (gas-amount ?gas) 1))
        :effect (and (decrease (mineral-amount)   1) (decrease (gas-amount)  1) (increase (Hero_Alan_Schezar_Turret-amount ?unit) 1) (has-unit ?unit))
    )
    ...
    (:action build-hero-jim-raynor-vulture
        ...
        :effect (and (decrease (mineral-amount)   150) (increase (Hero_Jim_Raynor_Vulture-amount ?unit) 1) (has-unit ?unit))
    )
    ...
    (:action build-hero-edmund-duke-tank-mode
        ...
        :effect (and (decrease (mineral-amount)   300) (decrease (gas-amount)  200) (increase (Hero_Edmund_Duke_Tank_Mode-amount ?unit) 1) (has-unit ?unit))
    )

    (:action build-hero-edmund-duke-tank-mode-turret
        :parameters (?unit - Hero_Edmund_Duke_Tank_Mode_Turret ?mineral - mineral ?gas - gas)
        :precondition (and (>= (mineral-amount ?mineral) 1) (>= (gas-amount ?gas) 1))
        :effect (and (decrease (mineral-amount)   1) (decrease (gas-amount)  1) (increase (Hero_Edmund_Duke_Tank_Mode_Turret-amount ?unit) 1) (has-unit ?unit))
    )

    (:action build-hero-edmund-duke-siege-mode
        :parameters (?unit - Hero_Edmund_Duke_Siege_Mode ?mineral - mineral ?gas - gas)
        :precondition (and (>= (mineral-amount ?mineral) 300) (>= (gas-amount ?gas) 200))
        :effect (and (decrease (mineral-amount)   300) (decrease (gas-amount)  200) (increase (Hero_Edmund_Duke_Siege_Mode-amount ?unit) 1) (has-unit ?unit))
    )
    ...
    (:action build-hero-edmund-duke-siege-mode-turret
        ...
        :precondition (and (>= (mineral-amount ?mineral) 1) (>= (gas-amount ?gas) 1))
        :effect (and (decrease (mineral-amount)   1) (decrease (gas-amount)  1) (increase (Hero_Edmund_Duke_Siege_Mode_Turret-amount ?unit) 1) (has-unit ?unit))
    )
    ...
    (:action build-terran-siege-tank-siege-mode
        ...
        :precondition (and (>= (mineral-amount ?mineral) 150) (>= (gas-amount ?gas) 100) (has-building Terran_Machine_Shop) (has-building Terran_Factory))
        :effect (and (decrease (mineral-amount)   150) (decrease (gas-amount)  100) (increase (Terran_Siege_Tank_Siege_Mode-amount ?unit) 1) (has-unit ?unit))
    )
    ...
    (:action build-terran-siege-tank-siege-mode-turret
        ...
        :precondition (and (>= (mineral-amount ?mineral) 1) (>= (gas-amount ?gas) 1))
        :effect (and (decrease (mineral-amount)   1) (decrease (gas-amount)  1) (increase (Terran_Siege_Tank_Siege_Mode_Turret-amount ?unit) 1) (has-unit ?unit))
    )
    ...
    (:action build-terran-science-facility
        ...
        :effect (and (decrease (mineral-amount)   100) (decrease (gas-amount)  150) (increase (Terran_Science_Facility-amount ?unit) 1) (has-unit ?unit))
    )
    ...
    (:action build-special-crashed-norad-ii
        ...
        :precondition (and (>= (mineral-amount ?mineral) 800) (>= (gas-amount ?gas) 600))
        :effect (and (decrease (mineral-amount)   800) (decrease (gas-amount)  600) (increase (Special_Crashed_Norad_II-amount ?unit) 1) (has-unit ?unit))
    )
    ...
    (:action build-special-terran-flag-beacon
        ...
        :precondition (and (>= (mineral-amount ?mineral) 50) (>= (gas-amount ?gas) 50))
        :effect (and (decrease (mineral-amount)   50) (decrease (gas-amount)  50) (increase (Special_Terran_Flag_Beacon-amount ?unit) 1) (has-unit ?unit))
    )
    ...
    (:action build-special-power-generator
        ...
        :effect (and (decrease (mineral-amount)   200) (decrease (gas-amount)  50) (increase (Special_Power_Generator-amount ?unit) 1) (has-unit ?unit))
    )
)
