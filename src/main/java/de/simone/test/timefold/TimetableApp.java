...
import de.simone.test.timefold.domain.Room;
import de.simone.test.timefold.domain.Timeslot;
import de.simone.test.timefold.domain.Timetable;
import de.simone.test.timefold.solver.TimetableConstraintProvider;
