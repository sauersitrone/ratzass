...
import de.simone.ui.component.chart.*;
import de.simone.ui.component.chart.renderer.other.ChartCandlestickRenderer;
import de.simone.ui.component.chart.themes.ColorThemes;
import de.simone.ui.component.chart.themes.DefaultChartTheme;
import de.simone.ui.component.chart.utils.ToolBarCategoryOrientation;
import de.simone.ui.component.chart.utils.ToolBarTimeSeriesChartRenderer;
import de.simone.ui.component.dashboard.CardBox;
import de.simone.ui.sample.SampleData;
...
public class FormDashboard extends Form {
    ...
    private void createCard() {
        ...
        cardBox = new CardBox();
        cardBox.addCardItem(createIcon("ui/icons/dashboard/customer.svg", DefaultChartTheme.getColor(0)), "Total Customer");
        cardBox.addCardItem(createIcon("ui/icons/dashboard/income.svg", DefaultChartTheme.getColor(1)), "Total Income");
        cardBox.addCardItem(createIcon("ui/icons/dashboard/expense.svg", DefaultChartTheme.getColor(2)), "Total Expense");
        cardBox.addCardItem(createIcon("ui/icons/dashboard/profit.svg", DefaultChartTheme.getColor(3)), "Last Profit");
        panel.add(cardBox);
