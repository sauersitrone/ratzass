...
public class MainForm extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        JButton buttonDrawer = new JButton(new FlatSVGIcon("ui/icons/menu.svg", 0.5f));
        buttonUndo = new JButton(new FlatSVGIcon("ui/icons/undo.svg", 0.5f));
        buttonRedo = new JButton(new FlatSVGIcon("ui/icons/redo.svg", 0.5f));
        buttonRefresh = new JButton(new FlatSVGIcon("ui/icons/refresh.svg", 0.5f));
    ...
    private JPanel createFooter() {
        ...
        lbJava.putClientProperty(FlatClientProperties.STYLE, "" +
                "foreground:$Label.disabledForeground;");
        lbJava.setIcon(new SVGIconUIColor("ui/icons/java.svg", 1f, "Label.disabledForeground"));
        panel.add(lbJava);
