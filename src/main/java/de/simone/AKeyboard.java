...
import de.simone.game.GameSpeed;
import de.simone.game.RGame;

public class AKeyboard implements NativeKeyListener {
    /**
     * It looks that Starcraft needs to receive a pause with a delay, otherwise the
     * speed settings don't work.
     */
    ...
    public void nativeKeyPressed(NativeKeyEvent e) {
        ...
        switch (e.getKeyCode()) {
            ...
            case 11:
                // Key "0"
                RGame.changeDisableUI(!Env.DISABLE_GUI);
                break;
        }
    }

    private static void exit() {
        System.out.println("Exit was requested manually. Cleaning up...");
        RUtils.exitGame();
    }
