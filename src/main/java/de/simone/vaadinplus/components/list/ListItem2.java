...
public class ListItem2 extends com.vaadin.flow.component.html.ListItem {
    ...
    public ListItem2() {
        ...
        // terry: beacuse i use in grid with stripes
        removeClassNames(Background.BASE, Padding.Horizontal.MEDIUM, Padding.Vertical.SMALL);
    ...
    public ListItem2(String primary, String secondary) {
        this(null, new Span(primary), new Span(secondary), null);
    }

    public ListItem2(Component primary, Component secondary) {
        this(null, primary, secondary, null);
    }

    public ListItem2(Component prefix, String primary, String secondary) {
        this(prefix, new Span(primary), new Span(secondary), null);
    }

    public ListItem2(String primary, String secondary, Component suffix) {
        this(null, new Span(primary), new Span(secondary), suffix);
    }

    public ListItem2(Component prefix, String primary, String secondary, Component suffix) {
        this(prefix, new Span(primary), new Span(secondary), suffix);
    }

    public ListItem2(Component prefix, Component primary, Component secondary, Component suffix) {
        this();
        primary.addClassName(TextOverflow.ELLIPSIS);
        setPrefix(prefix);
        setPrimary(primary);
    ...
    /**
     * Removes both the column (horizontal) and row (vertical) gap between
     * components.
     */
    ...
    public Layout getPrimary() {
        return primary;
    }

    public Layout getSecondary() {
        return secondary;
    }
