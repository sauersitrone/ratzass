...
import de.simone.vaadinplus.components.Tag;
import de.simone.vaadinplus.components.list.*;
...
public class ListsView extends ComponentView {
    ...
    private List2 createList() {
        return new List2(
                new ListItem2(PERSON_1, PERSON_1_EMAIL),
                new ListItem2(PERSON_2, PERSON_2_EMAIL),
                new ListItem2(PERSON_3, PERSON_3_EMAIL)
        );
    }

    private List2 createListWithPrefix() {
        return new List2(
                new ListItem2(new Avatar(PERSON_1), PERSON_1, PERSON_1_EMAIL),
                new ListItem2(new Avatar(PERSON_2), PERSON_2, PERSON_2_EMAIL),
                new ListItem2(new Avatar(PERSON_3), PERSON_3, PERSON_3_EMAIL)
        );
    }

    private List2 createListWithSuffix() {
        return new List2(
                new ListItem2(PERSON_1, PERSON_1_EMAIL, createSuffix(PERSON_1)),
                new ListItem2(PERSON_2, PERSON_2_EMAIL, createSuffix(PERSON_2)),
                new ListItem2(PERSON_3, PERSON_3_EMAIL, createSuffix(PERSON_3))
        );
    }
    ...
    private List2 createListWithPrefixSuffix() {
        return new List2(
                new ListItem2(new Avatar(PERSON_1), PERSON_1, PERSON_1_EMAIL, createSuffix(PERSON_1)),
                new ListItem2(new Avatar(PERSON_2), PERSON_2, PERSON_2_EMAIL, createSuffix(PERSON_2)),
                new ListItem2(new Avatar(PERSON_3), PERSON_3, PERSON_3_EMAIL, createSuffix(PERSON_3))
        );
    }

    private List2 createGridList() {
        List2 list = createList();
    ...
    private List2 createVersionHistory() {
        return new List2(
                new ListItem2(
    ...
    private List2 createNotifications() {
        return new List2(
    ...
    private List2 createTimeline() {
        ...
        return new List2(item1, item2, item3, item4);
    }
