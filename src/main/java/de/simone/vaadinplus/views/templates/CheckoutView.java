...
import de.simone.vaadinplus.components.*;
import de.simone.vaadinplus.themes.ButtonTheme;
import de.simone.vaadinplus.themes.InputTheme;
import de.simone.vaadinplus.themes.RadioButtonTheme;
import de.simone.vaadinplus.utilities.Breakpoint;
import de.simone.vaadinplus.utilities.Size;
...
@PermitAll
@PageTitle("Checkout")
@SuppressWarnings({ "rawtypes", "unchecked", "java:S1192", "java:S3740" })
...
public class CheckoutView extends Main {
    ...
    private Component renderPaymentMethod(PaymentMethod method) {
        switch (method) {
            ...
            case PAYPAL:
                return createImage("https://upload.wikimedia.org/wikipedia/commons/b/b5/PayPal.svg",
                        method.getDisplayName());

            case GOOGLE_PAY:
                return createImage("https://upload.wikimedia.org/wikipedia/commons/f/f2/Google_Pay_Logo.svg",
                        method.getDisplayName());
        }
    }
    ...
    private Component createCreditCard() {
        ...
        Image mastercard = new Image("https://upload.wikimedia.org/wikipedia/commons/a/a4/Mastercard_2019_logo.svg",
                "Mastercard");
